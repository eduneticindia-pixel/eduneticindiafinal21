            ...
            {roadmap.map((phase, idx) => (
              <div key={idx} className="relative">
                <div className="flex flex-col md:flex-row items-center gap-8 md:gap-0">
                  {/* Phase Marker */}
                  <div className="absolute left-8 md:left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-cyan-primary shadow-[0_0_20px_rgba(0,255,255,0.5)] z-10 hidden md:block" />
            ...
            <div className="flex flex-col md:flex-row gap-12 items-center">
              ...
              <div className="w-full md:w-auto">
                <a 
                  ...
                  className="w-full md:w-auto px-12 py-6 bg-cyan-primary text-black font-black uppercase tracking-widest rounded-2xl hover:bg-cyan-light transition-all transform hover:scale-105 shadow-[0_0_50px_rgba(0,255,255,0.2)] flex items-center justify-center gap-3"
                >
