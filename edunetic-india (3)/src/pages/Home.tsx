        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center z-20">
            <motion.div
              ...
              className="px-8 py-4 md:px-12 md:py-6 rounded-full bg-cyan-primary/10 border border-cyan-primary/30 backdrop-blur-xl shadow-[0_0_50px_rgba(0,255,255,0.1)]"
            >
